...
#for loop for all chromosomes. I will change it if needed
#for i in range(24):
#  file = '/home/rasa/Documents/DNA/cgDNA+_clean/cgDNA+_clean/SkirmantasData/AllCentresCh37/allsubsequencesCh'+str(i)+'CpG147.txt'

## to add
#  with open('shuffledCh1CpG.txt', 'w') as f:
